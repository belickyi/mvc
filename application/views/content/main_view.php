...
<div class="main-slider js-main-slider">
  <div class="main-slider__i" style="background-image:url(images/slider/slide1.jpg);">
    <div class="wrap main-slider__i-wrap">
      <div class="main-slider__i-text"><span>НАДЕЖНАЯ ТИПОГРАФИЯ<br>СО СВОИМ ПРОИЗВОДСТВОМ</span>
        <p>Наша цель проста - предоставить нашим клиентам высокий уровень качества и сервиса.<br>Мы верим, что отличные идеи начинаются с отличного дизайна и печати.</p><a class="button button_view-white" href="#">Подробнее</a>
      </div>
    </div>
  </div>
  <div class="main-slider__i" style="background-image:url(images/slider/slide2.jpg);">
    <div class="wrap main-slider__i-wrap">
      <div class="main-slider__i-text"><span>НАДЕЖНАЯ ТИПОГРАФИЯ<br>СО СВОИМ ПРОИЗВОДСТВОМ</span>
        <p>Наша цель проста - предоставить нашим клиентам высокий уровень качества и сервиса.<br>Мы верим, что отличные идеи начинаются с отличного дизайна и печати.</p><a class="button button_view-white" href="#">Подробнее</a>
      </div>
  ...
  <div class="main-slider__i" style="background-image:url(images/slider/slide3.jpg);">
    <div class="wrap main-slider__i-wrap">
      <div class="main-slider__i-text3"><span>НАДЕЖНАЯ ТИПОГРАФИЯ<br>СО СВОИМ ПРОИЗВОДСТВОМ</span>
        <p>Наша цель проста - предоставить нашим клиентам высокий уровень качества и сервиса.<br>Мы верим, что отличные идеи начинаются с отличного дизайна и печати.</p><a class="button button_view-action" href="#">Подробнее</a>
      </div>
    </div>
  </div>
</div>
<!--advantages-->
<div class="advantages flex-space wrap">
  <div class="advantages__item fadeInRight animated wow">
    <div class="advantages__img"><img src="images/medal.png" alt="medal"></div>
    <div class="advantages__title">
      <h3>ВЫСОЧАЙШЕЕ КАЧЕСТВО</h3>
    </div>
    <div class="advantages__text">
      <p>Наше оборудование позволяет нам предоставить вам высочайшее качесвто печати при низких ценах</p>
    </div>
  </div>
  <div class="advantages__item fadeInRight animated wow">
    <div class="advantages__img"><img src="images/speed.png" alt="speed"></div>
    <div class="advantages__title">
      <h3>СКОРОСТЬ ПЕЧАТИ</h3>
    </div>
    <div class="advantages__text">
      <p>Наш штат менеджеров более 30 человек, поэтому мы вовремя обработаем ваш заказ</p>
    </div>
  </div>
  <div class="advantages__item fadeInRight animated wow">
    <div class="advantages__img"><img src="images/money.png" alt="money"></div>
    <div class="advantages__title">
      <h3>СКИДКИ ДЛЯ ПАРТНЁРОВ</h3>
    </div>
    <div class="advantages__text">
      <p>Больше тиражей - больше партнерская скидка! Система скидок в личном кабинете партнера.</p>
    </div>
  </div>
</div>
<!--categories-->
        ...
        <form class="calculator__form flex-wrap flex-inline flex-evenly">
          <div class="calculator__left flex-column">
            ...
            <select class="select" name="format" id="format">
              ...
              <option value="5.1">A4 (210*297мм)</option>
              <option value="3.1">A5 (148*210мм)</option>
              <option value="2.1">A6 (105*158мм)</option>
            ...
            <select class="select" name="papper" id="papper">
              ...
              <option value="1.45">Мелованная 170г. (поплотнее)</option>
              <option value="1.54">Мелованная 200г. (плотная)</option>
              <option value="1.72">Мелованная 250г. (еще плотнее)</option>
              <option value="1.95">Мелованная 300г. (самая плотная)</option>
              <option value="1.33">Картон 310гр. (как у визиток)</option>
            ...
            <select class="select" name="laminazia" id="laminazia">
              ...
              <option value="1.5">Матовая 30мк. (односторонняя)</option>
              <option value="1.7">Матовая 30мк. (двухсторонняя)</option>
              <option value="1.7">Софт-тач 30мк. (матовая, односторонняя, с эффектом резины)</option>
              <option value="1.9">Матовая 30мк. (матовая, двухсторонняя, с эффектом резины)</option>
            </select>
          </div>
          <div class="calculator__right flex-column">
            ...
            <select class="select" name="big" id="big">
              ...
              <option value="1.75">3 бига</option>
            ...
            <select class="select" name="falz" id="falz">
              ...
              <option value="1.75">3 фальца</option>
              <option value="2">4 фальца</option>
            </select>
